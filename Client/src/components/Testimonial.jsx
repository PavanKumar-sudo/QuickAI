    ...
    const dummyTestimonialData = [
        {
            ...
            content: 'Ai has transformed our content creation process. The AI tools have helped us produce high-quality content faster than ever before.',
            rating: 4,
        },
        {
            ...
            content: 'contentAI has revolutionized the way I create content. The AI-powered tools are intuitive and easy to use, allowing me to focus on my creativity while the technology handles the rest.',
            rating: 5,
        },
        {
